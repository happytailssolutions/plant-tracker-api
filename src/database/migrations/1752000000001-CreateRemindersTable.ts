...
export class CreateRemindersTable1752000000001 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "reminders" DROP CONSTRAINT "FK_reminders_created_by"`);
        await queryRunner.query(`ALTER TABLE "reminders" DROP CONSTRAINT "FK_reminders_plant"`);
