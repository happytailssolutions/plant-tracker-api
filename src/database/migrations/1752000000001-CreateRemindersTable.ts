...
export class CreateRemindersTable1752000000001 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "IDX_plant_reminders_recurring_pattern"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "IDX_plant_reminders_notification_type"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "plant_reminders" DROP CONSTRAINT "FK_plant_reminders_plant"`,
    );
